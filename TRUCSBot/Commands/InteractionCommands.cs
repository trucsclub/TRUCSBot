...
namespace TRUCSBot.Commands
{
    public class InteractionCommands : BaseCommandModule
    {
        ...
        public async Task Sucks(CommandContext ctx,
            [RemainingText] [Description("The language that you think sucks")] string language)
        {
            if (language.Equals("C#", StringComparison.InvariantCultureIgnoreCase) ||
                language.Equals("CSharp", StringComparison.InvariantCultureIgnoreCase))
            {
